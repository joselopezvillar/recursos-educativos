<html>
    ...
    <body>
		...
		<h2 class="center">Lista de Jugadores</h2>
		...
		<?php
			echo '<a class="pure-button" href="jugadores.php?'."order=nomjugador".'">Nombre</a>'.'&nbsp;';
			echo '<a class="pure-button" href="jugadores.php?'."order=nacionalidad".'">Nacionalidad</a>'.'&nbsp;';
			echo '<a class="pure-button" href="jugadores.php?'."order=posicion".'">Posicion</a>'.'&nbsp;';
